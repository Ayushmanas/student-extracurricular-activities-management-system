...
<center>
<button style="vertical-align:middle" onclick="window.location ='enroll.php'"><span>Enroll for Course</span></button>
<button style="vertical-align:middle" onclick="window.location ='view_adm_prof.php'"><span>View Your Details</span></button>
<br>
</center>
</body>
<?php
